...
function ConfiguratorTabs() {
  ...
  return (
    ...
    >
      ...
      >
          <TabsList className='h-12 md:h-14 bg-black/60 backdrop-blur-xl border border-white/10 p-1.5 rounded-xl overflow-x-auto w-full md:w-auto flex flex-nowrap scrollbar-hide justify-start md:justify-center'>
